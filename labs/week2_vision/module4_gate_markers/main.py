...
Week 2 · Module 4 — Gate Markers (Seek a Gate) — Main orchestrator

Runs every step in sequence against the simulator:
    drone sim module4_gate_markers/main.py
...
neo_lab.run_module("Week 2 · Module 4 — Gate Markers (Seek a Gate)", [
